    ...
    return (
      <div>
        ...
        <div>
          ...
          <p>If you are offline or not signed into Manage a tenancy you can only ‘Save the issues for review with the 
            TRA later’. The TRA representative’s signature, name and role will not be saved at this stage. Once you are back 
            online and signed in, you will be able to ‘Email issues to the TRA for sign off’.</p>
