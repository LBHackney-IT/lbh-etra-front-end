...
it('Attendees component loads', () => {
   shallow(<MeetingAttendees attendees={defaultAttendees} onChangeAttendees={() => {}} readOnly={false} isComplete={false}/>);
});

describe('When we go to render the Attendees form with readonly false', () => {
   const wrapper = shallow(<MeetingAttendees attendees={defaultAttendees} onChangeAttendees={() => {}} readOnly={false} isComplete={false}/>); 
...
describe('When we go to render the Attendees component with readonly true', () => {
   const wrapper = shallow(<MeetingAttendees attendees={defaultAttendees} onChangeAttendees={() => {}} readOnly={true} isComplete={true}/>); 
